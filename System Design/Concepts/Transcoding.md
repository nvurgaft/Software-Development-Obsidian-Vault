...
Transcoding is heavily used by service providers such as Youtube and Netflix. When a creator uploads a video, these service providers compress video files, create multiple versions of the video with different resolutions and bitrates. 
When the file is streamed, it helps save network throughput and improves latency when providing the correct video resolution to the correct device.
...
An ML model can scan the audio and create subtitles for the video.
